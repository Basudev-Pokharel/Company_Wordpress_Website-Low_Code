			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - My First WordPress App</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - My First WordPress App</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://my-first-wordpress-app.lndo.site/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
